                                                            ...
                                                            enum Rotation rotation_gH)
{
    ...
    //if (!dev_gyro) {
		//hal.uartE->printf("LSM9DS0: %s, !dev_gyro || !dev_accel\n", __FUNCTION__);
        return nullptr;
    }
    ...
    //new AP_InertialSensor_LSM9DS0(_imu, std::move(dev_gyro));
...
void AP_InertialSensor_LSM9DS0::start(void)
{
	...
	//hal.uartE->printf("LSM9DS0: %s\n", __FUNCTION__);

    /* start the timer process to read samples */
    //_dev_gyro->register_periodic_callback(1000, FUNCTOR_BIND_MEMBER(&AP_InertialSensor_LSM9DS0::_poll_data, void));
    _dev_gyro->register_periodic_callback(1000000, FUNCTOR_BIND_MEMBER(&AP_InertialSensor_LSM9DS0::_poll_data, void));
}
