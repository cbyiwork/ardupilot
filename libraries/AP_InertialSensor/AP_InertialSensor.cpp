...
#define GET_I2C_DEVICE(bus, address) hal.i2c_mgr->get_device(bus, address)
    ...
    HAL_INS_PROBE_LIST;
	// added by ycb, for nrf24l01 driver, 20200304

	ADD_BACKEND(AP_InertialSensor_NRF24L01::probe(*this, hal.spi->get_device(HAL_INS_NRF24L01_NAME),
													  hal.spi->get_device(HAL_INS_NRF24L01_NAME)));
	/*ADD_BACKEND(AP_InertialSensor_LSM9DS0::probe( *this,
                                                      ...
                                                      ROTATION_ROLL_180_YAW_90));*/
	//ADD_BACKEND(AP_InertialSensor_LSM9DS0::probe(*this, hal.spi->get_device(HAL_INS_NRF24L01_NAME)));
	...
	ddd
	hal.console->printf("board type: %d\n", AP_BoardConfig::get_board_type());
    ...
    case AP_BoardConfig::PX4_BOARD_SP01:
		...
		//ADD_BACKEND(AP_InertialSensor_NRF24L01::probe(*this, hal.spi->get_device(HAL_INS_NRF24L01_NAME), ROTATION_NONE));
        break;
